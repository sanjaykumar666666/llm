...
ENTITY_CATEGORY_MAP = {
    ...
    "MEDICAL_DIAGNOSIS": CATEGORY_MEDICAL,
    "PRESCRIPTION_DATA": CATEGORY_MEDICAL,
    "PRESCRIPTION_MEDICATION": CATEGORY_MEDICAL,
    ...
    "CONFIDENTIAL_BUSINESS_INFO": CATEGORY_BUSINESS,
    "TRADE_SECRET": CATEGORY_BUSINESS,
